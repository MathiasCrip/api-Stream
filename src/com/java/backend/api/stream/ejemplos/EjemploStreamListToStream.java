...
public class EjemploStreamListToStream {
    public static void main(String[] args) {
        ...
        lista.add(new Usuario("Andrés", "Sotelo"));
...
//        Transformamos la listra en un tipo Stream() y operamos map, para convertir todos los nombres y apellidos en mayusculas
//        flatMap -> para retornar un stream del nombre que sea igual a 'bruce', sino, retorna un stream vacio, despues, denuevo
//        el map para transformar el nombre y apellido en minuscula y por ultimo, imprimimos con peek()
